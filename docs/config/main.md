...
| remarks_word   | ゲーム結果にメモを残す場合に付けるキーワード                                | 文字列                     | 麻雀メモ                                   | メモ登録ワード                                                                        |
| remarks_suffix | *成績登録キーワード* と `remarks_suffix` の組み合わせをメモ登録ワードとする | 文字列<br>(カンマ区切り)   |                                            | カンマ区切りで複数ワードの設定が可能                                                  |
...
| command_suffix       | *成績登録キーワード* と `command_suffix` の組み合わせを機能を呼び出すキーワードとする | 文字列<br>(カンマ区切り) | 空欄     |   〇    |  〇   |   〇    |   〇   |  〇   | カンマ区切りで複数ワードの設定が可能                 |
...
| commandword | command_suffix | keywords<br>(成績登録キーワード) |      登録されるキーワード      |
| :---------: | :------------: | :------------------------------: | :----------------------------: |
|      ×      |       ×        |                ×                 |      デフォルトキーワード      |
|     〇      |       ×        |                ×                 |          commandword           |
|     〇      |       ×        |                〇                |          commandword           |
...
| command_suffix     | *成績登録キーワード* と `command_suffix` の組み合わせを機能を呼び出すキーワードとする | 文字列<br>(カンマ区切り) | 空欄         |                                      |
