...
select
    ...
    count(my_rank = 1 or null) as my_rank1,
    count(my_rank = 2 or null) as my_rank2,
    count(my_rank = 3 or null) as my_rank3,
    count(my_rank = 4 or null) as my_rank4,
    ...
    count(vs_rank = 1 or null) as vs_rank1,
    count(vs_rank = 2 or null) as vs_rank2,
    count(vs_rank = 3 or null) as vs_rank3,
    count(vs_rank = 4 or null) as vs_rank4,
