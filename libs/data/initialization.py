...
def setup_rul_data() -> None:
    """ルールデータ取り込み"""
    if g.cfg.setting.rule_config and not g.cfg.setting.rule_config.exists():
        new_conf = g.cfg.config_dir / str(g.cfg.setting.rule_config)
        if new_conf.exists():
